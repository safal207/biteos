...
[English README](README.md) · **[Открыть демо](https://safal207.github.io/biteos/)** · [Большое табло](https://safal207.github.io/biteos/#kiosk)
...
Оригинальный код BiteOS распространяется по [лицензии MIT](LICENSE). Это разрешение не распространяется на фотографии Roby’s, сторонние библиотеки, шрифты и фирменные материалы: см. [NOTICE.md](NOTICE.md) и [происхождение ресурсов](docs/assets.md).
